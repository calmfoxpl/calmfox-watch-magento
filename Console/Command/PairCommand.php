...
class PairCommand extends Command
{
    ...
    {
        $this->setName('calmfox:watch:pair')
            ->setDescription('Łączy sklep z istniejącą stroną w panelu Calmfox Watch')
            ->addArgument('token', InputArgument::OPTIONAL, 'Klucz instalacyjny z ekranu Integracje (fxp_live_…). Bez niego użyjemy zapamiętanego.', '');
