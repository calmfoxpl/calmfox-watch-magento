 ...
 *
 * Klasa jest świadomie bez Magento — tak jak reszta rdzenia modułu — więc
 * da się ją sprawdzić testem bez kontenera obiektów, bazy i sklepu.
 */
final class ScoreRing
{
    ...
    /**
     * Barwy obszarów na JASNYM tle — panel administracyjny Magento jest biały.
