...
/**
 * Pojedyncze sprawdzenie w kontrakcie pakietów CMS: ok / warn / fail. Tylko
 * `fail` przełącza adres kontrolny na HTTP 503 i budzi monitoring, `warn`
 * zostaje w panelu i w raporcie. Identyfikator jest częścią kontraktu (katalog
 * parametrów w panelu opisuje każdy check własnym zdaniem), więc nie wymyślamy
 * nowych dla rzeczy, które już mają swój identyfikator.
 */
