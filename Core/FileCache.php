 ...
 * z pamięci podręcznej Magento: gdy padnie Redis albo baza, adres kontrolny ma
 * dalej odpowiadać i mówić, co jest zepsute. Poza tym jeden z checków sprawdza
 * właśnie pamięć podręczną aplikacji, więc trzymanie w niej własnych wyników
 * byłoby błędnym kołem. Trzeci powód jest magentowy: `bin/magento cache:flush`
 * leci przy każdym wdrożeniu i skasowałby także pomiar rozmiaru instalacji.
 */
class FileCache
{
