...
/**
 * Historia zmian wersji bez haka aktualizacji. Magento nie ma odpowiednika
 * `upgrader_process_complete` z WordPressa: moduły wchodzą Composerem, często
 * z zupełnie innej maszyny, a `setup:upgrade` tylko dokłada zmiany w bazie.
 * Dlatego porównujemy MIGAWKI: co się zmieniło między poprzednim a bieżącym
 * odczytem vendor/composer/installed.php.
 *
 ...
 * wdrożeniu albo nocne zadanie), ale przy sklepie bez ruchu może to być
 * więcej. Do zdania „awaria zaczęła się po aktualizacji modułu X" to wystarcza,
 * do rozliczania wdrożeń co do sekundy nie.
 */
final class VersionSnapshot
{
    /**
     * Pakiety platformy: ich zmiana to `core`, reszta to `plugin`. Metapakiet
     * wydania ma dwie nazwy (Community i Commerce), a `magento/framework`
     * bierzemy dlatego, że na wdrożeniach z osobnymi modułami to on niesie
     * numer wydania. Motywów tu nie ma: w Magento są zwykłymi pakietami.
     */
