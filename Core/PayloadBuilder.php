...
final class PayloadBuilder
{
    ...
    /**
     * Pole `wp` nazywa się tak ze względów historycznych i niesie wersję
     * PLATFORMY (tutaj: Magento). `updates` POMIJAMY w całości, dopóki nikt nie
     * policzył zaległych aktualizacji: zero znaczy „sprawdzone, nie ma czego
     * aktualizować" i nie wolno go użyć jako atrapy, bo panel pokazałby zieloną
     * wartość wziętą z powietrza.
     *
    ...
    public static function site(?string $platformVersion, string $phpVersion, string $pluginVersion, ?array $updates = null): array
    {
        ...
        if (null !== $updates) {
            $site['updates'] = [
                ...
                // Magento ma motywy, ale wdraża je Composer razem z resztą pakietów
                // i nie ma osobnego licznika ich aktualizacji. Zamiast zgadywać,
                // trzymamy tu zero: liczba pakietów obejmuje także motywy.
