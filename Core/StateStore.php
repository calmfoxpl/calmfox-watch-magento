...
/**
 * Stan modułu w PLIKU, świadomie nie w bazie. Powód jest w kontrakcie:
 ...
 * W Magento dochodzi drugi powód: konfiguracja w core_config_data idzie przez
 * pamięć podręczną konfiguracji, którą wdrożenie czyści w połowie pracy.
 *
...
class StateStore
{
    ...
    private function ensureDir(): void
    {
        ...
        // Tania polisa na wypadek, gdyby ktoś ustawił katalog stanu wewnątrz pub/:
        // w pliku leży sekret adresu kontrolnego, więc serwer WWW nie ma prawa go wydać.
